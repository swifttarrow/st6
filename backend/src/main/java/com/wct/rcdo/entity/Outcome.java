...
public class Outcome {
    ...
    public UUID getDefiningObjectiveId() { return definingObjectiveId; }
    public void setDefiningObjectiveId(UUID definingObjectiveId) { this.definingObjectiveId = definingObjectiveId; }
